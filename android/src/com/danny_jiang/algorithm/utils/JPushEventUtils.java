...
public class JPushEventUtils {
     ...
     * @param context
     */
    public static void onBrowseEvent(Context context, String visualizerId) {
//        BrowseEvent browseEvent = new BrowseEvent("test_browseID",//设置浏览内容id
//                "深圳热点新闻",//设置浏览的内容的名称
//                "news", //设置浏览的内容类型
//                30);//设置浏览的内容时长,单位秒
//        BrowseEvent browseEvent = new BrowseEvent();
//        browseEvent.setBrowseId(visualizerId);
//
//        JAnalyticsInterface.onEvent(context, browseEvent);

        BrowseEvent browseEvent = new BrowseEvent(visualizerId,//设置浏览内容id
                visualizerId,//设置浏览的内容的名称
                "open_activity", //设置浏览的内容类型
                30);//设置浏览的内容时长,单位秒
